...
describe("Nav when logged in", () => {
  ...
  beforeEach(() => {
    ...
    global.localStorage.setItem('refreshToken', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2MmQzYTBmNTAwMzg4NjlmNGZhYTM2NjAiLCJyb2xlcyI6WyJ1c2VyIiwiZG9jdG9yIl0sImlhdCI6MTY1ODk4NDYwOCwiZXhwIjoxNjU5MDcxMDA4fQ.iY0Rq8QkyJGAYwitSEgcV62uzVvUhRYDjGHwpI5z_8s');
  ...
  it("Allows users to redirect to bookings", async () => {
  ...
  it("Allows users to logout", async () => {
    ...
    await waitFor(() => {
      expect(screen.getByRole("button", { name: "Make a Booking" })).toBeInTheDocument;
