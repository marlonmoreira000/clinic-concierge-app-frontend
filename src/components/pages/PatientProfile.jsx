...
const PatientProfile = () => {
  ...
  const onFinish = async (values) => {
    ...
    try {
      const response = await axios.post("https://clinic-concierge.herokuapp.com/api/v1/patients", request, {
        headers: {
      ...
      <div className="bg-[#f0edeb] py-8">
        <div className="p-12 flex flex-col justify-center max-w-[400px] mx-auto border border-gray-300 rounded-lg bg-white">
          <Form
            ...
            >
              <Input placeholder="Contact Number" maxLength={10} minLength={9} />
            </Form.Item>
            <Input.Group compact>
              <Form.Item name="street_number" label="Address" rules={
                [
                  {
                    required: true,
              ...
              <Form.Item name="street_name" rules={
                [
                  {
                    required: true,
            ...
            <Form.Item name="state"
              ...
              <Select data-testid="select state" placeholder="State">
                ...
                <Select.Option value="Australian Capital Territory">ACT</Select.Option>
